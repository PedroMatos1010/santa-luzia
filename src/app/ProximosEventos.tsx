    ...
    return (
        <section className="bg-teal-900 py-24 px-6 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                {/* MENSAGEM SE NÃO HOUVER EVENTOS OU LISTA DE CARTÕES */}
                {ultimosEventos.length === 0 ? (
                    <div className="bg-teal-800/50 border border-teal-600/30 rounded-3xl p-10 text-center max-w-xl mx-auto mb-16 shadow-xl backdrop-blur-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mx-auto text-teal-300 mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <h3 className="text-2xl font-bold text-white mb-3">Programa em construção</h3>
                        <p className="text-teal-100">A comissão está a terminar a organização do próximo evento. Fica atento às novidades!</p>
                    </div>
                ) : (
                    <>
